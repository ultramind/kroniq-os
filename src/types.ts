...
export interface ProductPackage { id: string; name: string; unitsPerPack: number; sku?: string; price: number; minimumSellingPrice?: number; active?: boolean }
export interface Product { id: string; name: string; sku: string; price: number; costPrice: number; minimumSellingPrice?: number; stock: number; category: string; baseUnit?: string; packages?: ProductPackage[]; sourceProductId?: string; packagingId?: string; packageName?: string; unitsPerPackage?: number; lowStockThreshold?: number; active?: boolean; description?: string; imageUrl?: string; imageUrls?: string[]; onlinePublished?: boolean; featured?: boolean }
export interface CartItem extends Product { quantity: number; listPrice?: number; priceOverrideReason?: string; sourceProductId?: string; packagingId?: string; packageName?: string; unitsPerPackage?: number }
...
export interface SaleItem { id: string; saleId: string; productId: string; productName: string; quantity: number; unitPrice: number; listPrice?: number; priceOverrideReason?: string; costPrice?: number; packagingId?: string; packageName?: string; unitsPerPackage?: number; returnedQuantity?: number }
