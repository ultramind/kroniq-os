...
export function CompanyRegistration({ onBack, onSignedIn }: { onBack: () => void; onSignedIn: () => void }) {
  ...
  return (
    <main className="min-h-screen bg-white p-4 sm:p-6 lg:p-8">
      <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-6xl overflow-hidden border border-zinc-200 bg-white shadow-[0_24px_80px_rgb(11_17_33_/_9%)] lg:grid-cols-[.9fr_1.1fr]">
        <section
          className="relative flex min-h-[300px] flex-col justify-between overflow-hidden bg-[#f7f8fa] p-7 sm:p-10 lg:p-14"
          style={{
            backgroundImage:
        ...
        >
          <Link
            ...
            className="inline-flex h-10 w-fit items-center border border-[#0B1121] bg-white px-3 text-sm font-bold tracking-[.16em] text-[#0B1121]"
          >
            KRONIQOS
          </Link>
          <div>
            ...
            <h1 className="m-0 max-w-md text-4xl font-semibold tracking-tight text-[#0B1121] sm:text-5xl">
              Built for the way your business actually works.
            </h1>
            <p className="mt-5 max-w-md text-base leading-7 text-zinc-600">
              Set up retail, services, or both. You will create your company details in the next step.
            </p>
          ...
          <p className="mb-0 text-xs text-zinc-500">© {new Date().getFullYear()} Kroniqos</p>
        </section>
        <section className="bg-white p-7 sm:p-10 lg:p-14">
          ...
          <div className="mx-auto max-w-lg">
            <Button
              type="text"
              className="!mb-8 !px-0 !text-zinc-600"
            ...
            <Typography.Paragraph type="secondary">
              You will become the first administrator for your business workspace.
            ...
            <Form form={form} layout="vertical" className="mt-8" onFinish={(values) => void submit(values)}>
              <Form.Item
                name="fullName"
                label="Your full name"
                rules={[{ required: true, message: 'Enter your name.' }]}
              >
                <Input autoFocus size="large" autoComplete="name" placeholder="Your name" />
              </Form.Item>
              <Form.Item
                name="email"
                label="Work email"
