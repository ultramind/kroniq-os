...
export function SupportTicketForm() {
  ...
  const submit = async (values: { subject: string; description: string; priority: string }) => {
    ...
    form.resetFields()
    api.success('Support ticket sent. Our team can now review it.')
  }
  return (
    <Card
    ...
    >
      ...
      <p className="text-sm text-slate-500">
        Send a question, issue, or request to the Kronicle support team.
      </p>
      <Form
        form={form}
        layout="vertical"
      ...
      >
        ...
        <Form.Item name="description" label="How can we help?" rules={[{ required: true, min: 10 }]}>
